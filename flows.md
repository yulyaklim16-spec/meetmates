...
| Находка | Куда идёт |
|---|---|
| **Тупик остался один из четырнадцати** — остальные оказались возвратами без стрелки | Легенда дополнена терминалом «Job не закрыт … назад»; настоящий тупик — пустой старт (`D-02`); «автор молчит» — закрыто уточнением §5.4: отклик живёт, пока жив запрос, и его можно отозвать |
